 ...
 */
window.dgFootVersion = 'v733'; console.log('[demigod] foot v733-core loaded');
(function(){
...
'<p class="dg-p-note">LIVE = real visitors can hear you. Solo still works with NPCs. SF names are flavor only.</p>',
  ...
  events: {
    ...
    html:
      ...
      '<button type="button" class="dg-ev-cta-sec" id="dg-ev-open-rsvp">Open Demigod RSVPs</button>' +
...
window.__dgFootVer='733';console.log('Demigod v733');
