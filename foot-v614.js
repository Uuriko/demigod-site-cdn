 ...
 */
window.dgFootVersion = 'v614'; console.log('[demigod] foot v614-core loaded');
(function(){
...
(function (root, factory) {
  ...
  Engine.prototype.lookRoom = function (verbose) {
    ...
    if (verbose === true && !brief) this.print('(HELP · EXITS · HOME · SAY · CODEX · SKIP)', 'sys');
  };
  ...
  Engine.prototype.cmd = function (raw) {
    ...
    switch (verb) {
      ...
      case 'give': {
        ...
        if (/^codex$/i.test(gName)) {
          ch.inv = inv.filter(function (x) { return x !== gid; });
          saveChar(ch);
          this.print('You offer ' + ((ITEMS[gid] && ITEMS[gid].name) || gid) + ' to Codex. The Immortal accepts with a nod.', 'sys');
          return;
        }
      ...
      case 'news':
      case 'motd':
        this.print('News: SF Night District is a social MUD for trydemigod.com visitors. Talk first. Codex is Immortal. Multi: node demigod-mud-app.mjs', 'sys');
        return;
      case 'bug':
      case 'typo':
      case 'idea':
      ...
      case 'tutorial':
        this.print(
          ...
          'Immortal: codex <msg>  ·  tutorial: skip\n' +
...
window.__dgFootVer='614';console.log('Demigod v614');
