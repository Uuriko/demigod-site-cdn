 ...
 */
window.dgFootVersion = 'v666'; console.log('[demigod] foot v666-core loaded');
(function(){
...
function hero(){
  qa('.hero-section h1,.hero-title,.header h1').forEach(function(e){
    e.innerHTML='Evidence first.<br><em class="dg-em">Both sides approve.</em>';
  });
...
var DG_BLOG_POSTS=[{"slug":"epicurus-garden-hacker-houses","category":"Market","title":"Epicurus' Garden, monasteries, and SF hacker houses","summary":"A recurring pattern: selected people, shared rules, and proximity when the work is hard. From Athens to monastics to modern technical group houses — and what still applies in SF.","body":"Around 306 BCE, Epicurus bought a modest house and garden just outside Athens, past the Dipylon gate, between the city wall and the paths toward the Academy. The price, if Diogenes Laërtius has it right, was eighty minae. Not a marble school. A place to live, eat, argue, and keep people who actually wanted the work.\n\nThe Garden was school and household at once. Shared meals. Shared talk. A deliberate step back from the status noise of the agora. Women studied there. So did people the rest of the city would have kept out. The goal was not fame. It was ataraxia, a calm mind, reached by limiting the desires that look shiny and deliver headaches, and by treating friendship as load-bearing, not decorative.\n\nSelection was quiet and unforgiving. Chase applause in the square long enough and you drifted back to the city. Sit at the plain table and return to the same hard questions week after week, and you stayed. That filter is why the school lasted generations after Epicurus died. His will left instructions for successors, care for friends' children, freedom for slaves who had studied. The container was designed to outlive the founder.\n\nThe same basic architecture shows up elsewhere, long before anyone said \"hacker house.\"\n\nPythagoras's circle in southern Italy ran a stricter, stranger commune: shared property, shared intellectual life, heavy norms. Monastic communities later kept a related pattern (seclusion, rule, mutual support, a higher aim than market status) and, ironically, preserved classical texts their doctrine sometimes disliked. Poggio's 1417 recovery of Lucretius from a monastic library is the famous example: the container carried material the creed did not celebrate. Structure can outlast content.\n\nThen the pattern lands in San Francisco.\n\nFrom informal founder houses in the early 2000s to more structured residencies, technical group living reappeared for local reasons: high rent, lonely intensity, and the simple fact that hard technical work compounds faster when the right people share meals, hallways, and late problems. Reporting on places like HF0 (short, selective residencies in large SF properties) and AGI House (research-and-community houses with events, dinners, and venture adjacency) describes the same mechanisms historians notice in older forms: selection, proximity, blended work and ordinary life, and a partial withdrawal from status games that waste attention.\n\nThe goals diverge. The Garden optimized for equilibrium. Many modern houses optimize for throughput — shipping, fundraising, model progress. Inclusivity diverges too. The ancient school was broad for its time; SF houses are usually narrow by skill and network. Longevity diverges most of all. Philosophical schools could last centuries. Market-cycle houses often last a funding season.\n\nWhat holds across both is not cosplay antiquity. It is a recurring answer to a recurring problem: how do you keep selected people close enough, under shared rules, that demanding work becomes normal instead of heroic?\n\nA few regularities keep showing up in both the historical record and contemporary accounts.\n\nProximity works when alignment holds. Put misaligned people in a beautiful house and you mostly get noise. Selection on norms and purpose beats selection on headcount. Intensity without recovery burns people out; the Garden's deliberate moderation is one old parameterization of that tradeoff. Modern houses that only know how to accelerate often discover attrition the hard way.\n\nNone of this is a claim that Epicurus invented Silicon Valley. The Garden was not a prototype for a Hillsborough mansion. The point is narrower and more useful. When isolation is expensive and the work is hard, humans keep reinventing co-located, rule-governed groups. Monasteries, communes, kibbutzim, research houses, and founder residencies are different clothes on a stubborn pattern.\n\nDemigod sits next to that pattern, not inside it. We are not a house. We are a matching path for SF startups and talent that keeps profiles private, moves evidence first, and only introduces people after both sides approve. The connection is cultural, not product feature-creep. San Francisco still runs on small rooms where trust is local, selection is real, and forced proximity without alignment is expensive.\n\nIf you are building or joining a group house, the historical lesson is not \"be more Greek.\" It is design the filter honestly, write the norms down, protect recovery as carefully as output, and notice when the house is optimizing for a metric that will dissolve the room.\n\nIf you are hiring or looking in SF and the house is not the unit, the same discipline still applies. Name the work. Name the constraints. Do not treat a warm introduction as a substitute for a shared decision.\n\nThe garden still whispers because the problem did not leave. Only the rent did.","image":"https://files.catbox.moe/urbco5.jpg","imageAlt":"Gold-on-dark mark for garden, cloister, and group-house pattern essay","publishedAt":"2026-07-17"}];
var DG_PAGES = {
  how: {
    title: 'How it works',
...
function openPage(id, push) {
  ...
  try {
    var KEEP = /^(epicurus-garden-hacker-houses)$/;
...
window.__dgFootVer='666';console.log('Demigod v666');
