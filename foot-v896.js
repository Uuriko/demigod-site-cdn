/*dg-foot-v896-core*/
window.dgFootVersion = 'v896'; console.log('[demigod] foot v896-core loaded');
(function(){
...
var DG_PAGES = {
  how: {
    ...
    desc: 'Share one role or private profile. A human calibrates the fit, both sides opt in, the startup runs its interview, and startups pay only on hire.',
    html:
      ...
      '<li><strong>Interview directly</strong> — after both say yes, a warm intro puts the startup and candidate together. The startup runs its own interview and hiring decision.</li>' +
...
window.__dgFootVer='896';console.log('Demigod v896');
