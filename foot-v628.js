 ...
 */
window.dgFootVersion = 'v628'; console.log('[demigod] foot v628-core loaded');
(function(){
...
/* v628: torch — green flame, gold metal base (anti ice-cream) */
function ensureLogo(){
  try{
    var mark='<svg class="dg-mark" data-v="628" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 32 32" aria-hidden="true" focusable="false"> <rect width="32" height="32" rx="8" fill="#03140d"/> <path fill="#a6ffcb" d="M17.2 2.8C14.6 5.2 12 7.1 12 10.2a4.2 4.2 0 0 0 8.4 0c0-1.9-.9-3.2-1.9-4.5-.7-.9-1.2-1.8-1.3-2.9z"/> <path fill="#10c674" d="M16.3 7.2c.95 1.05 1.8 1.95 1.8 3.15a1.95 1.95 0 1 1-3.9 0c0-1.2 1.1-2.1 2.1-3.15z"/> <rect x="8.5" y="14.2" width="15" height="2.6" rx="1.2" fill="#E8D5A3"/> <path fill="#C9A84C" d="M10 16.8h12l-1.9 4.2H11.9L10 16.8z"/> <path fill="#C9A84C" d="M12.6 21h6.8l-1.9 7.6a1.5 1.5 0 0 1-3 0L12.6 21z"/> <ellipse cx="16" cy="28.6" rx="2" ry="1.1" fill="#E8D5A3"/> </svg>';
    qa('a.nav_logo,.nav_logo,a.w-nav-brand,a.logo-link,.logo-link,.w-nav-brand').forEach(function(a){
      ...
      if(a.querySelector('svg.dg-mark[data-v="628"]')){a.dataset.dgMark='628';return;}
      a.dataset.dgMark='628';
    ...
    if(document.documentElement.dataset.dgFav!=='628'){
      document.documentElement.dataset.dgFav='628';
      try{
        var href='data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2232%22%20height%3D%2232%22%20viewBox%3D%220%200%2032%2032%22%3E%20%3Crect%20width%3D%2232%22%20height%3D%2232%22%20rx%3D%228%22%20fill%3D%22%2303140d%22/%3E%20%3Cpath%20fill%3D%22%23a6ffcb%22%20d%3D%22M17.2%202.8C14.6%205.2%2012%207.1%2012%2010.2a4.2%204.2%200%200%200%208.4%200c0-1.9-.9-3.2-1.9-4.5-.7-.9-1.2-1.8-1.3-2.9z%22/%3E%20%3Cpath%20fill%3D%22%2310c674%22%20d%3D%22M16.3%207.2c.95%201.05%201.8%201.95%201.8%203.15a1.95%201.95%200%201%201-3.9%200c0-1.2%201.1-2.1%202.1-3.15z%22/%3E%20%3Crect%20x%3D%228.5%22%20y%3D%2214.2%22%20width%3D%2215%22%20height%3D%222.6%22%20rx%3D%221.2%22%20fill%3D%22%23E8D5A3%22/%3E%20%3Cpath%20fill%3D%22%23C9A84C%22%20d%3D%22M10%2016.8h12l-1.9%204.2H11.9L10%2016.8z%22/%3E%20%3Cpath%20fill%3D%22%23C9A84C%22%20d%3D%22M12.6%2021h6.8l-1.9%207.6a1.5%201.5%200%200%201-3%200L12.6%2021z%22/%3E%20%3Cellipse%20cx%3D%2216%22%20cy%3D%2228.6%22%20rx%3D%222%22%20ry%3D%221.1%22%20fill%3D%22%23E8D5A3%22/%3E%20%3C/svg%3E';
...
window.__dgFootVer='628';console.log('Demigod v628');
