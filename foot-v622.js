 ...
 */
window.dgFootVersion = 'v622'; console.log('[demigod] foot v622-core loaded');
(function(){
...
/* v622: Split D (Codex) — phosphor stem + signal bowl; re-apply when data-v changes */
function ensureLogo(){
  try{
    var mark='<svg class="dg-mark" data-v="622" width="28" height="28" viewBox="0 0 32 32" aria-hidden="true" focusable="false"><rect width="32" height="32" rx="8" fill="#03140d"/><path fill="#a6ffcb" d="M8 7h7v5h-2v8h2v5H8z"/><path fill="#10c674" d="M15 7c6.3 0 10 3.4 10 9s-3.7 9-10 9v-5c3.5 0 5-1.3 5-4s-1.5-4-5-4z"/></svg>';
    qa('a.nav_logo,.nav_logo,a.w-nav-brand,a.logo-link,.logo-link,.w-nav-brand').forEach(function(a){
      ...
      if(a.querySelector('svg.dg-mark[data-v="622"]')){a.dataset.dgMark='622';return;}
      a.dataset.dgMark='622';
    ...
    // favicon once (head may lag; runtime override) — Split D SVG
    if(document.documentElement.dataset.dgFav!=='622'){
      document.documentElement.dataset.dgFav='622';
      try{
        var href='data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20viewBox%3D%220%200%2032%2032%22%3E%3Crect%20width%3D%2232%22%20height%3D%2232%22%20rx%3D%228%22%20fill%3D%22%2303140d%22/%3E%3Cpath%20fill%3D%22%23a6ffcb%22%20d%3D%22M8%207h7v5h-2v8h2v5H8z%22/%3E%3Cpath%20fill%3D%22%2310c674%22%20d%3D%22M15%207c6.3%200%2010%203.4%2010%209s-3.7%209-10%209v-5c3.5%200%205-1.3%205-4s-1.5-4-5-4z%22/%3E%3C/svg%3E';
...
window.__dgFootVer='622';console.log('Demigod v622');
