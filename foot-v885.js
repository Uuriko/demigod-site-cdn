/*dg-foot-v885-core*/
window.dgFootVersion = 'v885'; console.log('[demigod] foot v885-core loaded');
(function(){
...
var WIZ_CFG={
  ...
  engineer:{
    steps:[['welcome'],['sf-bay'],['full-name'],['seeker-email'],['skills-stack'],['experience'],['availability'],['salary-expectation'],['work-auth'],['resume'],['__submit__'],['__thanks__']],
    welcome:{t:'Join the talent network',b:'For people open to SF Bay startup roles. About 2 minutes · private · free forever. Shared only after you approve an intro. Press Enter to continue.',btn:'Start my profile'},
    thanks:ENGINEER_OK,
    optional:[]
  }
};
...
window.__dgFootVer='885';console.log('Demigod v885');
