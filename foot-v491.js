/*dg-foot-v491-core*/
/**
 * v491 Notes: publish ship-when-ready card + deep-link slug
 ...
 * v347 align active WIZ, confirmation, and pricing contact copy on hello@trydemigod.com
 ...
 */
window.dgFootVersion = 'v491'; console.log('[demigod] foot v491-core loaded');
(function(){
...
pricingBilling:'Confirmations by email from hello@trydemigod.com. SMS/card payments pending.',
footerTag:'Human-matched SF talent · both approve · 10% when a hire starts',
...
var STARTUP_OK='Brief received. A human will review it. hello@trydemigod.com follows up — no bot spam. Payments/SMS pending.';
var ENGINEER_OK='Profile saved privately. hello@trydemigod.com follows up only if fit. Payments/SMS pending.';
...
var WIZ_CFG={startup:{steps:[['welcome'],['contact-email'],['company-name'],['company-stage'],['role-title'],['stack-needs'],['90day-outcome'],['__submit__'],['__thanks__']],welcome:{t:"I'm hiring",b:'Role + one 90-day outcome. Human review only.',btn:'Start brief →'},thanks:STARTUP_OK,total:7,optional:['phone','salary-range','why-this-role','role-jd','timeline','team-size']},engineer:{steps:[['welcome'],['full-name'],['seeker-email'],['linkedin-url'],['skills-stack'],['experience'],['sf-bay'],['__submit__'],['__thanks__']],welcome:{t:'Find a job',b:'One profile. Private until both sides approve.',btn:'Create profile →'},thanks:ENGINEER_OK,total:7,optional:['phone','links','resume','salary-expectation','why-startups','availability']},partner:{steps:[['welcome'],['partner-type'],['partner-name'],['partner-email'],['partner-phone'],['partner-org'],['referral-plan'],['partner-linkedin'],['partner-notes'],['__submit__'],['__thanks__']],welcome:{t:'Partner',b:'Refer outstanding people. Earn 20% of fee on hire.',btn:'Apply →'},thanks:PARTNER_OK,total:9,optional:['partner-phone','partner-linkedin','partner-notes']}};
...
var DG_PAGES = {
  ...
  pricing: {
    ...
    html:
      ...
      '<li><strong>Payments/SMS pending</strong> — commercial confirmations by email from hello@trydemigod.com.</li>' +
      '</ul>',
  },
  faq: {
    title: 'FAQ',
    ...
    html:
      ...
      '<details class="dg-p-det"><summary>What happens after I submit?</summary><p>A human reads your brief or profile. If a fit looks real, we propose it to both sides. hello@trydemigod.com follows up — no SLA clock, no bot spam.</p></details>' +
      ...
      '<details class="dg-p-det"><summary>How long does it take?</summary><p>No SLA clock. Timing depends on role difficulty and response pace. Every brief gets careful human review — hello@trydemigod.com follows up.</p></details>' +
      '<details class="dg-p-det"><summary>Are payments and SMS live?</summary><p>Not yet. Commercial confirmations and follow-ups are by email (hello@trydemigod.com). Stripe and Twilio are pending — we say so honestly on the site.</p></details>' +
      ...
      '<details class="dg-p-det"><summary>Can I partner or refer talent?</summary><p>Yes. Refer outstanding people and earn 20% of the placement fee on successful hires. Email hello@trydemigod.com with “Partner” in the subject.</p></details>' +
      ...
      '<details class="dg-p-det"><summary>Where can I read updates?</summary><p>See <a href="/?p=blog" data-dg-page="blog">Notes</a> for short product and market posts. Share a note via /?p=blog#note-{slug} (opens full note). Questions: hello@trydemigod.com.</p></details>',
  },
  hire: {
    title: "I'm hiring",
    doc: 'Hire · Demigod',
  ...
  legal: {
    title: 'Privacy & Terms',
    doc: 'Legal · Demigod',
    desc: 'Plain-language privacy and terms. Contact hello@trydemigod.com for questions.',
    html:
      '<h3 class="dg-p-h3">Privacy</h3><p>We use your brief or profile to match. No selling lists. Profiles shared only after both sides approve. Contact us to update or delete data: hello@trydemigod.com.</p>' +
  ...
  pilot: {
    title: 'Pilot',
    doc: 'Pilot · Demigod',
    desc: 'White-glove pilot for SF founders. Email hello@trydemigod.com to start. SMS/card pending.',
    html:
  ...
  blog: {
    ...
    html:
      ...
      '<article class="dg-blog-card" id="note-90-day-outcomes"><img src="https://files.catbox.moe/urbco5.jpg" alt="Why 90-day outcomes beat keyword JDs" loading="lazy" width="1200" height="675"><small>Product</small><h3>Why 90-day outcomes beat keyword JDs</h3><p>Match on a measurable first-quarter result, not a stack laundry list.</p><details class="dg-blog-more"><summary>Full note · Why 90-day outcomes beat keyword JDs</summary><p>Keyword filters flood both sides with false matches. One measurable 90-day outcome creates a shared decision frame before identities move: what ships, what proof counts, and what would make either side pass. Stack laundry lists can wait until both sides have already opted into a real conversation.</p></details></article>' +
      '<article class="dg-blog-card" id="note-both-approve"><img src="https://files.catbox.moe/wewe5r.jpg" alt="Both sides approve before intros" loading="lazy" width="1200" height="675"><small>Privacy</small><h3>Both sides approve before intros</h3><p>Evidence first. Names only after founder and talent both opt in.</p><details class="dg-blog-more"><summary>Full note · Both sides approve before intros</summary><p>Profiles stay private. Evidence packets move first: outcome, proof, constraints, and one open gap. Contact details move only when founder and talent both approve. That is slower than a public feed and faster at real decisions — trust over volume.</p></details></article>' +
      '<article class="dg-blog-card" id="note-ten-percent"><img src="https://files.catbox.moe/eg561c.jpg" alt="10% on hire, free for talent" loading="lazy" width="1200" height="675"><small>Pricing</small><h3>10% on hire, free for talent</h3><p>10% of first-year cash on hire. Free for talent. No retainers.</p><details class="dg-blog-more"><summary>Full note · 10% on hire, free for talent</summary><p>Agencies often sit at 15–25% plus retainers. Demigod charges 10% of first-year cash only when a hire starts. Talent never pays. No subscription to browse people; commercial follow-up is email (hello@trydemigod.com) while card tooling stays pending.</p></details></article>' +
      '<article class="dg-blog-card" id="note-private-match-notes"><img src="https://files.catbox.moe/i4j3y0.jpg" alt="What belongs in a private match note" loading="lazy" width="1200" height="675"><small>Product</small><h3>What belongs in a private match note</h3><p>The smallest useful packet: proof, constraints, one evidence gap, and a private yes or pass.</p><details class="dg-blog-more"><summary>Full note · What belongs in a private match note</summary><p>A private match note is the smallest packet that lets both sides decide without exposing identities. Keep it tight: (1) one measurable 90-day outcome, (2) proof the candidate can ship that outcome, (3) hard constraints (location, comp band, visa, hours), (4) one explicit evidence gap, and (5) a private yes/pass from the reviewer. Skip stack laundry lists and culture fluff. If the note cannot support a clear yes or pass, it is not ready to move.</p></details></article>' +
      '<article class="dg-blog-card" id="note-human-review-over-volume"><img src="https://files.catbox.moe/zhxopd.jpg" alt="Human review over application volume" loading="lazy" width="1200" height="675"><small>Market</small><h3>Human review over application volume</h3><p>Why fewer, evidence-backed introductions can be more useful than another public feed.</p><details class="dg-blog-more"><summary>Full note · Human review over application volume</summary><p>Public job feeds optimize for application volume. Demigod optimizes for fewer, evidence-backed introductions after human review. That means slower top-of-funnel and faster shared decision frames: one outcome, mutual approval, and contact only after both sides opt in. Volume metrics look quieter; quality of intros and decision speed are the signals that matter for early SF startups.</p></details></article>' +
      '<article class="dg-blog-card" id="note-ship-when-ready"><img src="https://files.catbox.moe/zhxopd.jpg" alt="Ship when ready — do not hoard website wins" loading="lazy" width="1200" height="675"><small>Ops</small><h3>Ship when ready — do not hoard website wins</h3><p>Disk leading live by dozens of versions is thrash. Batch, verify, publish.</p><details class="dg-blog-more"><summary>Full note · Ship when ready — do not hoard website wins</summary><p>Agent teams can improve foot, head, and Notes all day. Value only lands when the site is published. Cadence: verify:source green, claim the foot lock, bin/dg ship run (CDN + paste), confirm live version. Prefer a coherent ship candidate over endless micro-bumps. Demigod is a product — ship it.</p></details></article>' +
      '</div>',
  },
  method: {
    title: 'Method',
...
function pageCss() {
  ...
  s.textContent =
    ...
    '#dg-page .dg-blog-more summary{cursor:pointer;color:#E8D5A3;font-weight:600;min-height:44px;display:flex;align-items:center}' +
...
function focusBlogNoteFromHash(root) {
  try {
    ...
    try {
      ...
      if (nt) document.title = nt + ' · Notes · Demigod';
    } catch (eTitle) {}
...
function deepLink(){
  ...
  try{
    ...
    if(/^note-/.test(h)||/^(90-day-outcomes|both-approve|ten-percent|private-match-notes|human-review-over-volume|ship-when-ready)$/.test(h)){ openPage('blog',false); window.__dgDeepLinked=1; return; }
    if(!w)return;
    var open=function(){
...
function boot(){if(!document.body)return;forceMainVisible();run();ensureReducedMotionHeroCss();ensureTapTargetCss();finalButtonLabels();try{wireLogoHome()}catch(e){}deepLink();try{document.body.classList.add('dg-ready');document.body.setAttribute('data-dg-ready','1')}catch(e){}try{if(window.requestIdleCallback)requestIdleCallback(function(){try{orgJsonLd()}catch(e){}});else setTimeout(function(){try{orgJsonLd()}catch(e){}},1200)}catch(e){}}boot();document.addEventListener('DOMContentLoaded',boot);[400,1500].forEach(function(ms){setTimeout(boot,ms)});/* v190: drop t=50 forceMainVisible — boot/run cover */
...
window.__dgFootVer='491';console.log('Demigod v491');
