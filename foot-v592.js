 ...
 */
window.dgFootVersion = 'v592'; console.log('[demigod] foot v592-core loaded');
(function(){
...
/* v592 Frege-night institutional — phosphor + serif + motion + dual CTA */
...
window.__dgFootVer='592';console.log('Demigod v592');
