 ...
 */
window.dgFootVersion = 'v495'; console.log('[demigod] foot v495-core loaded');
(function(){
...
function scrubContactEmail(){
  try{
    ...
    qa('a[href*="mailto:hello@"]').forEach(function(a){
      var h=(a.getAttribute('href')||'').replace(bad,'mailto:'+good);
      a.setAttribute('href',h.indexOf('mailto:')===0?h:'mailto:'+good);
      if(/hello@/i.test(a.textContent||'')) a.textContent=good;
    });
  }catch(e){}
}
...
window.__dgFootVer='495';console.log('Demigod v495');
