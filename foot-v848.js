/*dg-foot-v848-core*/
window.dgFootVersion = 'v848'; console.log('[demigod] foot v848-core loaded');
(function(){
...
function openPage(id, push) {
  ...
  try {
    ...
    var preferred = { how:'/how', pricing:'/pricing', hire:'/hire', talent:'/talent', faq:'/faq', legal:'/legal', refer:'/refer', partners:'/partners', about:'/about', events:'/events', map:'/map', contact:'/contact', blog:'/blog', sample:'/sample', compare:'/compare', status:'/status', event:'/event' };
...
window.__dgFootVer='848';console.log('Demigod v848');
