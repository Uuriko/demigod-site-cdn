/*dg-foot-v943-core*/
window.dgFootVersion = 'v943'; console.log('[demigod] foot v943-core loaded');
(function(){
...
+"section:has(.pricing-grid){background:var(--dg-night)!important;padding:clamp(2.75rem,6vh,4.25rem) 1.25rem clamp(3rem,7vh,5rem)!important}"
...
window.__dgFootVer='943';console.log('Demigod v943');
