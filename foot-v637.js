 ...
 */
window.dgFootVersion = 'v637'; console.log('[demigod] foot v637-core loaded');
(function(){
...
var DG_PAGES = {
  ...
  events: {
    ...
    html:
      ...
      '<p class="dg-ec-note">Full cycle co-pilot — ideate through debrief. You approve and send. AI when :3460 is up; else offline guide.</p>' +
...
function eventsBotChatMount(root) {
  ...
  function offline(msg) {
    ...
    return 'I run the full cycle: Ideate → Resource → Plan → RSVP → Run → Follow-up → Debrief → next. You stay host; no auto-DM. Try: "8 seats, next Thu/Fri, founders + eng, outcome: 3 second meetings" — or use Sponsor / Venue / Volunteer forms above. Live AI needs :3460.';
  }
...
window.__dgFootVer='637';console.log('Demigod v637');
