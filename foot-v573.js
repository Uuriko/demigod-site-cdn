 ...
 */
window.dgFootVersion = 'v573'; console.log('[demigod] foot v573-core loaded');
(function(){
...
+".title-accent-gold,.title-accent-cream,.title-accent-red,.title-accent-blue{color:#141414!important;display:inline}"
+".hero-section p,.header p,.subheading,.hero-description{max-width:38ch!important;font-size:1.08rem!important;line-height:1.55!important;color:#5c574f!important;margin:0 0 1rem!important;animation:none!important}"
...
window.__dgFootVer='573';console.log('Demigod v573');
