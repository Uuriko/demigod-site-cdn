 ...
 */
window.dgFootVersion = 'v608'; console.log('[demigod] foot v608-core loaded');
(function(){
...
/* v608 frege-typeform WIZ — calm night card, serif Q, quiet progress, no gold */
...
window.__dgFootVer='608';console.log('Demigod v608');
