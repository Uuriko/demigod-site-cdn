 ...
 */
window.dgFootVersion = 'v668'; console.log('[demigod] foot v668-core loaded');
(function(){
...
var DG_PAGES = {
  ...
  mud: {
    ...
    html:
      '<p class="dg-p-lead">A <strong>full-page</strong> social text MUD set in <strong>San Francisco</strong>. Meet other visitors (when multi is on). Tap the buttons under the log if you hate typing — or type <code>start</code> for a 3-line guide. Stuck? <code>pray</code> to Vesper. Skip the tutorial anytime with <code>skip</code>.</p>' +
      '<ul class="dg-p-list">' +
...
(function (root, factory) {
  ...
  var HELP_TOPICS = {
    easy: 'Easy: LOOK · N/S/E/W · SAY hi · WHO · MAP · PRAY · SKIP · START. Buttons below the input do the same.',
  ...
  Engine.prototype.cmd = function (raw) {
    ...
    switch (verb) {
      ...
      case 'tips':
        ...
        this.print(
          'Easy play:\n' +
          '  LOOK — see the room  ·  N/S/E/W — walk  ·  MAP — district sketch\n' +
          '  SAY hi — talk  ·  WHO — people  ·  PRAY — ask Vesper (Immortal)\n' +
          '  HELP — full list  ·  SKIP — skip tutorial  ·  buttons below also work',
          'sys'
        );
  ...
  function mount(root, opts) {
    ...
    box.innerHTML =
      ...
      '<button type="button" data-mud-cmd="exits">Exits</button>' +
      '<button type="button" data-mud-cmd="map">Map</button>' +
      '<button type="button" data-mud-cmd="who">Who</button>' +
      ...
      '<button type="button" data-mud-cmd="start">Start</button>' +
      '<button type="button" data-mud-cmd="skip">Skip</button>' +
      '</div>' +
      ...
      '</form>' +
      '<p class="dg-mud-hint">Tap buttons or type. Talk to people · walk with N/S/E/W · <code>pray</code> if stuck · <code>skip</code> tutorial</p>' +
      '</div>';
...
window.__dgFootVer='668';console.log('Demigod v668');
