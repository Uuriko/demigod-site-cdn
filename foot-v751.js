 ...
 */
window.dgFootVersion = 'v751'; console.log('[demigod] foot v751-core loaded');
(function(){
...
'<p class="dg-p-note">LIVE = real visitors can hear you. Solo still works with NPCs. SF names are flavor only.</p>',
  ...
  events: {
    ...
    html:
      ...
      '<button type="button" class="dg-ev-cta-sec" id="dg-ev-open-rsvp" style="display:none">Open Demigod RSVPs</button>' +
      '<a class="dg-ev-cta-sec" href="#" id="dg-ev-invite-link" style="display:none" target="_blank" rel="noopener">Guest invite page</a>' +
      '</div>' +
      '<p class="dg-ev-msg" id="dg-ev-rsvp-ops-msg" role="status" aria-live="polite"></p>' +
      '<div id="dg-ev-rsvp-host" class="dg-ev-rsvp-host" style="display:none" aria-label="Host RSVP list"></div>' +
      /* Primary conversation comes before the calendar and lifecycle reference. */
      ...
      '<p class="dg-ec-note">Chat ideas or ask status. Public chat drafts plans; only the private operator can execute them.</p>' +
      ...
      '<textarea id="dg-ec-input" class="dg-ec-input" rows="2" maxlength="2000" placeholder="e.g. plan a 40-person SoMa party — free venue + drink sponsor" required></textarea>' +
      ...
      '<li><span>03</span><strong>Plan</strong><small>Agenda · Demigod invite · optional Partiful</small></li>' +
      '<li><span>04</span><strong>RSVP</strong><small>Demigod RSVP · reminder queue</small></li>' +
...
function pageCss() {
  ...
  if (existing && existing.getAttribute('data-v') === '731') return;
  if (existing) existing.remove();
  var s = document.createElement('style');
  s.id = 'dg-page-css';
  s.setAttribute('data-v', '731');
  s.textContent =
...
window.__dgFootVer='751';console.log('Demigod v751');
