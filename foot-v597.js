 ...
 */
window.dgFootVersion = 'v597'; console.log('[demigod] foot v597-core loaded');
(function(){
...
var STARTUP_OK='Got it. A human will read this. potter@trydemigod.com follows up if there is a real fit.';
...
var WIZ_THANKS={
  ...
  engineer:{head:'You are in',lead:'Your profile stays private. Free for talent. No blasts.',steps:['We store it securely','A human proposes only real fits','You approve before anyone gets your name'],done:'How it works'}
};
...
var WIZ_CFG={
  startup:{
    ...
    welcome:{t:"I'm hiring",b:'A short brief. One role. One clear 90-day outcome.',btn:'Continue'},
  ...
  engineer:{
    ...
    welcome:{t:"I'm looking",b:'One private profile. Free. Shared only when you approve.',btn:'Continue'},
...
var WIZ_Q={
  startup:{
    ...
    '__submit__':{q:'Look good?',h:'Submit when you are ready. A human reviews every brief.'}
  },
  engineer:{
    ...
    'experience':{q:'What have you shipped that you are proud of?',h:'Two or three concrete wins beat a long bio.'},
    ...
    'salary-expectation':{q:'Comp range? (optional)',h:'Helps us skip roles that will not fit.'},
...
function wizBuild(form, kind) {
  ...
  function collect() {
    ...
    /* v597: no localStorage draft persistence */
  }
...
window.__dgFootVer='597';console.log('Demigod v597');
