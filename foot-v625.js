 ...
 */
window.dgFootVersion = 'v625'; console.log('[demigod] foot v625-core loaded');
(function(){
...
/* v625: glow-lantern — 4 rects (cap/body/light/foot), child-drawable */
function ensureLogo(){
  try{
    var mark='<svg class="dg-mark" data-v="625" width="28" height="28" viewBox="0 0 32 32" aria-hidden="true" focusable="false"><rect width="32" height="32" rx="8" fill="#03140d"/><rect x="12" y="3" width="8" height="4" rx="1" fill="#10c674"/><rect x="6" y="7" width="20" height="18" rx="9" fill="#10c674"/><rect x="13" y="10" width="6" height="11" rx="3" fill="#a6ffcb"/><rect x="14" y="25" width="4" height="4" rx="1" fill="#a6ffcb"/></svg>';
    qa('a.nav_logo,.nav_logo,a.w-nav-brand,a.logo-link,.logo-link,.w-nav-brand').forEach(function(a){
      ...
      if(a.querySelector('svg.dg-mark[data-v="625"]')){a.dataset.dgMark='625';return;}
      a.dataset.dgMark='625';
    ...
    if(document.documentElement.dataset.dgFav!=='625'){
      document.documentElement.dataset.dgFav='625';
      try{
        var href='data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20viewBox%3D%220%200%2032%2032%22%3E%3Crect%20width%3D%2232%22%20height%3D%2232%22%20rx%3D%228%22%20fill%3D%22%2303140d%22/%3E%3Crect%20x%3D%2212%22%20y%3D%223%22%20width%3D%228%22%20height%3D%224%22%20rx%3D%221%22%20fill%3D%22%2310c674%22/%3E%3Crect%20x%3D%226%22%20y%3D%227%22%20width%3D%2220%22%20height%3D%2218%22%20rx%3D%229%22%20fill%3D%22%2310c674%22/%3E%3Crect%20x%3D%2213%22%20y%3D%2210%22%20width%3D%226%22%20height%3D%2211%22%20rx%3D%223%22%20fill%3D%22%23a6ffcb%22/%3E%3Crect%20x%3D%2214%22%20y%3D%2225%22%20width%3D%224%22%20height%3D%224%22%20rx%3D%221%22%20fill%3D%22%23a6ffcb%22/%3E%3C/svg%3E';
...
window.__dgFootVer='625';console.log('Demigod v625');
