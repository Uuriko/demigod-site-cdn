 ...
 */
window.dgFootVersion = 'v670'; console.log('[demigod] foot v670-core loaded');
(function(){
...
(function (root, factory) {
  ...
  var ROOMS = {
    plaza: {
      ...
      exits: { north: 'lobby', east: 'alley', west: 'cafe', south: 'dock', northeast: 'garden', southeast: 'market', southwest: 'transit' },
    ...
    roof: {
      name: 'SoMa Roof Deck',
      desc: 'Wind off the bay. Neon and cranes. Sutro Tower a faint trident west. Immortal Vesper is often "nearby" in spirit. Someone left a plant that is trying very hard.',
      exits: { down: 'lobby', east: 'helipad' },
      items: ['lantern', 'hoodie'],
    },
    mission: {
      ...
      exits: { east: 'cafe', north: 'bar', west: 'haight_edge', south: 'bookstore' },
      items: ['clipper', 'zine'],
    },
    bar: {
    ...
    parklet: {
      ...
      desc: 'A wooden deck where a parking space used to be. String lights, a dog, two founders who are not working. South of the coffee nook, north of the loft.',
      exits: { north: 'cafe', south: 'office', west: 'bookstore' },
      items: ['matcha', 'bike_lock'],
    },
    bookstore: {
  ...
  var NPCS = [
    ...
    },
    {
      ...
      look: 'Operator nursing a pint. No deck in sight. Good listener.',
      lines: [
    ...
    switch (verb) {
      ...
      case 'talk':
        ...
        if (/token for the bay/i.test(arg) && ch.room === 'dock' && ch.inv.indexOf('coin') >= 0) {
          ...
          said = true;
        } else if (/^(hi|hello)\b/i.test(arg) && ch.room === 'bar') {
      ...
      case 'map':
          ...
          '  also: showplace west of garden · emb path east of market\n' +
          'You are: ' + ch.room,
          'meta'
        );
        return;
...
window.__dgFootVer='670';console.log('Demigod v670');
