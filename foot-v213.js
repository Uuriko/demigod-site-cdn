 ...
 */
window.dgFootVersion = 'v213'; console.log('[demigod] foot v213-core loaded');
(function(){
...
heroTrustLine:'Both sides approve · 10% on hire · Not a job board',
...
engineerBody:'One private profile. Shared only after mutual yes.',
feeNote:'10% on hire. Candidates free. No upfront fee.',
...
footerTag:'Human-matched SF talent · mutual yes · 10% on hire',
trustKicker:'How it works',
trustSteps:['Brief or profile','Human match','Mutual yes → intro'],
ledgerKicker:'',
ledgerTitle:'',
ledgerRows:[],
...
var DG_PAGES = {
  ...
  pricing: {
    ...
    html:
      ...
      '<ul class="dg-p-list">' +
      '<li><strong>No subscription.</strong> No charge to submit a brief.</li>' +
  ...
  faq: {
    ...
    html:
      ...
      '<details class="dg-p-det"><summary>What is a 90-day outcome?</summary><p>One measurable result the hire must deliver in their first 90 days. We match against that, not a keyword soup.</p></details>' +
      '<details class="dg-p-det"><summary>Do you auto-message founders?</summary><p>No auto-DM blasts. Humans send outreach. The site is for inbound briefs and profiles.</p></details>',
  },
  hire: {
    title: "I'm hiring",
    doc: 'Hire · Demigod',
  ...
  founders: {
    ...
    desc: 'Human-matched SF talent. Brief a role. 10% on hire.',
    html:
      '<p class="dg-p-lead">You are hiring. We are not a job board. You write a brief + <strong>one 90-day outcome</strong>. A human proposes only when fit looks real — and both sides still say yes.</p>' +
      '<ul class="dg-p-list">' +
      '<li><strong>What you give:</strong> role, stage, must-haves, measurable 90-day result.</li>' +
      '<li><strong>What you get:</strong> a shortlist of strong fits, not a résumé dump.</li>' +
      '<li><strong>Fee:</strong> 10% of first-year cash when a hire starts. No upfront fee.</li>' +
      '<li><strong>Pending:</strong> card payments / SMS — confirmations by email for now.</li>' +
      '</ul>',
  },
  candidates: {
    title: 'For talent',
    doc: 'For talent · Demigod',
    desc: 'One private profile for SF startups. Free. Mutual yes only.',
    html:
      '<p class="dg-p-lead">One profile. <strong>Private until mutual yes.</strong> Free for candidates. We do not blast you to founders.</p>' +
      '<ul class="dg-p-list">' +
      '<li><strong>SF Bay focus</strong> — startups that actually hire humans, not spam.</li>' +
      '<li><strong>You approve</strong> before any intro goes out.</li>' +
      '<li><strong>No job-board feed</strong> — quality over volume.</li>' +
      '</ul>',
  },
  status: {
    title: 'Status',
    ...
    html:
      ...
      '<li><strong>Site:</strong> foot v212 decision home + chips + path pills</li>' +
...
function boot(){if(!document.body)return;try{document.body.classList.add('dg-ready')}catch(e){}forceMainVisible();run();finalButtonLabels();try{wireLogoHome()}catch(e){}deepLink();try{if(window.requestIdleCallback)requestIdleCallback(function(){try{orgJsonLd()}catch(e){}});else setTimeout(function(){try{orgJsonLd()}catch(e){}},1200)}catch(e){}}boot();document.addEventListener('DOMContentLoaded',boot);[400,1500].forEach(function(ms){setTimeout(boot,ms)});/* v190: drop t=50 forceMainVisible — boot/run cover */
...
window.__dgFootVer='213';console.log('Demigod v213');
