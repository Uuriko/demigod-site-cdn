 ...
 */
window.dgFootVersion = 'v830'; console.log('[demigod] foot v830-core loaded');
(function(){
...
function forceMainVisible() {
  ...
  try {
      ...
      if (allowDisplay) {
        ...
        if (cs.display === 'none') {
          ...
          var want = el.matches('html,body') ? 'block' :
            ...
            el.matches('.w-layout-grid,.pricing-grid,.steps-grid') ? 'grid' :
            'block';
    ...
    qa('.hero-section,.hero-container,.hero-content-left,.hero-content-right,.header,.nav_container,main,section.trust-section,section:not(.modal-overlay),.pricing-grid,.steps-grid,.step-card,.pricing-card,.premium-btn').forEach(function(el){
...
window.__dgFootVer='830';console.log('Demigod v830');
