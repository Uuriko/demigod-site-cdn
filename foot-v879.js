/*dg-foot-v879-core*/
window.dgFootVersion = 'v879'; console.log('[demigod] foot v879-core loaded');
(function(){
...
var COPY={
heroSub:'Start with one role and the result the hire must deliver in 90 days. '+MATCH_DISCLOSURE+' Names move only after both sides say yes.',
...
startupBody:'Role + 90-day outcome. '+MATCH_DISCLOSURE,
...
var WIZ_THANKS={
  startup:{head:'Brief in',lead:'Someone reads every submission. We only propose when the fit is real — both sides still have to say yes.',steps:['We read the role and 90-day outcome','Software compares; a human proposes','You approve before any intro']},
...
var WIZ_CFG={
  startup:{
    ...
    welcome:{t:'Hiring brief',b:'About 2 minutes · one question at a time. Role, 90-day outcome, real constraints. Press Enter to continue.',btn:'Start the brief'},
    thanks:STARTUP_OK,
    optional:[]
  },
  engineer:{
  ...
  qa('.modal-intro,#startup-modal .modal-intro,#jobseeker-modal .modal-intro').forEach(function(el){
    ...
    if(/curated SF candidates|match you to SF startups/i.test(t)){
      el.textContent=/startup|role|comp/i.test(t)
        ? 'Share the role, skills, and a 90-day outcome. Software compares the real constraints.'
...
window.__dgFootVer='879';console.log('Demigod v879');
