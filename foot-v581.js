 ...
 */
window.dgFootVersion = 'v581'; console.log('[demigod] foot v581-core loaded');
(function(){
...
var COPY={
heroSub:'Demigod tech ranks the fit. A human reviews every potential match. Both sides approve before an intro.',
badge:'SF STARTUP TALENT MATCHING',
heroTrustLine:'SF Bay Area · 10% on hire · Free for talent · No intro without mutual interest',
...
function hero(){
  qa('.hero-section h1,.hero-title,.header h1').forEach(function(e){
    e.innerHTML='The right people, <span class="title-accent-gold">with signal.</span>';
  });
...
function ctaHints(){
  ...
  qa('a[data-dg-cta]',host).forEach(function(a){
    ...
    wrap.appendChild(a);
    // put label+hint as structured content inside the link for equal cards
...
/* v573 Operator Calm layout fix — equal dual-path cards, no black pill bar, readable looking CTA */
"html,body{background:#F7F4EF!important;color:#141414!important}"
+".nav_container,.nav_left,.nav_right{background:transparent!important}"
+".nav_container{position:sticky!important;top:0!important;z-index:50!important;display:flex!important;align-items:center!important;justify-content:space-between!important;padding:.85rem 1.25rem!important;backdrop-filter:blur(10px);background:rgba(247,244,239,.92)!important;border-bottom:1px solid #e4ddd3!important}"
+".nav_logo .paragraph_large,[data-brand-name]{color:#141414!important;font-weight:700!important;letter-spacing:.02em}"
+".nav_logo-icon{color:#1F4B99!important}"
+"#dg-nav-hire,#dg-nav-talent,header a.button,nav a.button{border-radius:999px!important;min-height:40px!important;padding:.45rem .95rem!important;font-weight:650!important;text-decoration:none!important}"
+"#dg-nav-hire,header a.button.on-inverse,nav a.button.on-inverse{background:#1F4B99!important;color:#fff!important;border:1px solid #1F4B99!important}"
+"#dg-nav-talent,header a.button.is-job,nav a.button.is-job{background:#fff!important;color:#141414!important;border:1px solid #cfc7bb!important}"
+".hero-section,.header{background:#F7F4EF!important;background-image:none!important;min-height:auto!important;display:flex!important;align-items:flex-start!important;padding:clamp(2.25rem,7vh,4rem) 1.25rem 2.5rem!important;border-bottom:1px solid #e4ddd3!important}"
+".hero-grid-background,.grid-col-line,.hero-content-right,.statue-frame,.statue-svg,.statue-wrapper{display:none!important}"
+".hero-container,.hero-content-left{max-width:42rem!important;margin:0!important;width:100%!important}"
+".hero-section h1,.header h1,.hero-title{text-shadow:none!important;letter-spacing:-.03em;max-width:16ch!important;font-size:clamp(2.35rem,6.5vw,3.5rem)!important;font-weight:700!important;line-height:1.05!important;margin:.45rem 0 .85rem!important;color:#141414!important;animation:none!important;text-transform:none!important}"
+".title-accent-gold,.title-accent-cream,.title-accent-red,.title-accent-blue,.hero-section h1 span,.header h1 span,.hero-title span{color:#141414!important;display:inline!important;background:none!important;-webkit-text-fill-color:#141414!important;background-image:none!important}"
+".hero-section p,.header p,.subheading,.hero-description{max-width:42ch!important;font-size:1.08rem!important;line-height:1.55!important;color:#5c574f!important;margin:0 0 1rem!important;animation:none!important}"
+".hero-badge,.badge-text{display:inline-flex!important;align-items:center!important;gap:.4rem!important;color:#5c574f!important;font-size:.7rem!important;font-weight:600!important;letter-spacing:.12em!important;text-transform:uppercase!important;border:1px solid #e4ddd3!important;border-radius:999px!important;padding:.28rem .75rem!important;background:#fff!important;min-height:auto!important}"
+".badge-dot{width:6px!important;height:6px!important;border-radius:50%!important;background:#1F4B99!important;box-shadow:none!important}"
+"#dg-hero-chips,.dg-trust-line{display:block!important;margin:0 0 1.15rem!important;color:#5c574f!important;font-size:.9rem!important;letter-spacing:.01em;animation:none!important;background:transparent!important}"
+"#dg-hero-chips .dg-chip{display:none!important}"
+"#dg-path-nudge{display:none!important}"
/* dual path equal cards */
+".hero-actions,.hero-actions.dg-path-pair{display:grid!important;grid-template-columns:1fr 1fr!important;gap:.75rem!important;align-items:stretch!important;margin:.35rem 0 0!important;max-width:32rem!important;width:100%!important;animation:none!important}"
+".hero-actions .dg-cta-wrap{display:block!important;min-width:0!important}"
+".hero-actions .dg-cta-wrap a,.hero-actions a.premium-btn,.hero-actions a.button,.hero-actions a.w-button,.hero-actions a[data-dg-cta]{box-sizing:border-box!important;display:flex!important;flex-direction:column!important;align-items:flex-start!important;justify-content:center!important;gap:.2rem!important;width:100%!important;min-height:72px!important;padding:1rem 1.1rem!important;border-radius:14px!important;font-weight:650!important;font-size:1rem!important;line-height:1.25!important;text-decoration:none!important;white-space:normal!important;cursor:pointer!important;box-shadow:none!important;transform:none!important}"
+".hero-actions a[data-dg-cta=hire],.hero-actions a.is-talent{background:#1F4B99!important;color:#fff!important;border:1px solid #1F4B99!important}"
+".hero-actions a[data-dg-cta=hire] .dg-cta-label,.hero-actions a[data-dg-cta=hire] .dg-cta-hint,.hero-actions a.is-talent .dg-cta-label,.hero-actions a.is-talent .dg-cta-hint{color:#fff!important}"
+".hero-actions a[data-dg-cta=hire] .dg-cta-hint,.hero-actions a.is-talent .dg-cta-hint{opacity:.88!important;font-weight:500!important;font-size:.82rem!important}"
+".hero-actions a[data-dg-cta=talent],.hero-actions a.is-job{background:#fff!important;color:#141414!important;border:1.5px solid #1F4B99!important}"
+".hero-actions a[data-dg-cta=talent] .dg-cta-label,.hero-actions a[data-dg-cta=talent] .btn-label,.hero-actions a[data-dg-cta=talent] .button_label,.hero-actions a[data-dg-cta=talent] *{color:#141414!important}"
+".hero-actions a[data-dg-cta=talent] .dg-cta-hint{color:#5c574f!important;opacity:1!important;font-weight:500!important;font-size:.82rem!important}"
+".hero-actions a .btn-arrow,.hero-actions a svg{display:none!important}"
+"#dg-bar a.dg-h{background:#1F4B99!important;color:#fff!important;border:1px solid #1F4B99!important}"
+"#dg-bar a.dg-j{background:#fff!important;color:#141414!important;border:1.5px solid #1F4B99!important}"
/* path pills: light text links only — never a black bar */
+"#dg-path-pills{display:flex!important;flex-wrap:wrap!important;gap:.35rem 1.1rem!important;margin:1.1rem 0 0!important;padding:.85rem 0 0!important;border-top:1px solid #e4ddd3!important;background:transparent!important;animation:none!important;box-shadow:none!important}"
+"#dg-path-pills a{color:#5c574f!important;font-size:.9rem!important;font-weight:500!important;text-decoration:none!important;border:none!important;background:transparent!important;min-height:40px!important;display:inline-flex!important;align-items:center!important;padding:0!important;border-radius:0!important}"
+"#dg-path-pills a:hover,#dg-path-pills a:focus-visible{color:#1F4B99!important;outline:none}"
+"#dg-path-pills a:focus-visible{box-shadow:0 0 0 2px rgba(31,75,153,.35);border-radius:4px}"
...
/* kill charcoal bands below fold — paper everywhere on marketing sections */
+"section.trust-section,section:has(.steps-grid),section:has(.pricing-grid),body>section:not(.modal-overlay):not(#startup-modal):not(#jobseeker-modal),.w-section{display:block!important;visibility:visible!important;opacity:1!important;background:#F7F4EF!important;background-image:none!important;color:#141414!important;padding:2.75rem 1.25rem!important}"
...
+".trust-header h2,.heading_tertiary,section h2,.step-title{color:#141414!important;font-size:clamp(1.35rem,3vw,1.75rem)!important;font-weight:650!important;letter-spacing:-.02em!important;margin:.5rem 0 .4rem!important}"
+".trust-header p,.paragraph_large,.step-desc{color:#5c574f!important;font-size:1rem!important;max-width:40ch}"
...
+".step-card{background:#fff!important;border:1px solid #e4ddd3!important;border-radius:14px!important;padding:1.15rem 1.1rem!important;box-shadow:none!important;transition:border-color .15s ease;color:#141414!important}"
+".step-card:hover,.step-card:focus-within{transform:none!important;border-color:#1F4B99!important}"
+".step-num{color:#1F4B99!important;font-size:.75rem!important;font-weight:700!important;letter-spacing:.12em!important;margin-bottom:.45rem!important}"
+".step-title{font-size:1.05rem!important;font-weight:650!important;margin:0 0 .35rem!important}"
+".step-desc{font-size:.92rem!important;line-height:1.45!important;margin:0!important}"
...
+".pricing-card{background:#fff!important;border:1px solid #e4ddd3!important;border-radius:18px!important;padding:1.6rem 1.4rem!important;box-shadow:none!important;text-align:left!important;color:#141414!important}"
+".pricing-card h3{color:#5c574f!important;letter-spacing:.1em!important;font-size:.72rem!important;text-transform:uppercase!important;margin:0 0 .35rem!important}"
+".pricing-card .pricing-amount,.pricing-card .price,.pricing-card > div > div{color:#141414!important}"
+".pricing-card a.premium-btn,.pricing-card a.button{margin-top:1.1rem!important;min-height:48px!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;border-radius:14px!important;background:#1F4B99!important;color:#fff!important;border:none!important;padding:.7rem 1.2rem!important;font-weight:650!important}"
+".pricing-card-border-red,.pricing-card-divider{opacity:.35}"
+"#dg-legal-links{display:flex!important;flex-direction:column!important;align-items:center!important;gap:.45rem!important;margin:.75rem auto!important;max-width:28rem!important;padding:0 .75rem!important}"+"#dg-legal-links .dg-foot-primary,#dg-legal-links .dg-foot-more{display:flex!important;flex-wrap:wrap!important;justify-content:center!important;gap:.15rem .9rem!important}"+"#dg-legal-links .dg-foot-more a{color:#8a8378!important;font-size:.78rem!important}"+"#dg-legal-links .dg-foot-more a:hover{color:#5c574f!important}"
+"#dg-legal-links a{color:#5c574f!important;text-decoration:none!important;margin-right:0!important;font-size:.85rem!important;min-height:44px!important;display:inline-flex!important;align-items:center!important}"
+"#dg-legal-links a:hover,#dg-legal-links a:focus-visible{color:#1F4B99!important}"
+"#footer-email,footer a[href^=mailto]{color:#1F4B99!important;text-decoration:none!important;border-bottom:none;min-height:44px!important;display:inline-flex!important;align-items:center!important}"
+"#footer-email:hover,footer a[href^=mailto]:hover{color:#163a7a!important}"
...
+"footer,.footer{padding:2rem 1rem 2.5rem!important;text-align:center!important;border-top:1px solid #e4ddd3!important;max-width:32rem;margin-inline:auto;background:transparent!important}"
+"#demigod-footer-tag,footer .footer-tagline{font-size:.88rem!important;color:#8a8378!important;max-width:26rem;margin:.35rem auto!important;line-height:1.45!important}"
+"#dg-copyright,footer [class*=copyright],footer .text-color_secondary{color:#8a8378!important;font-size:.8rem!important;margin:.5rem auto 0!important}"
+"#main,main,h1.hero-title,.hero-section h1,#dg-page{scroll-margin-top:4.5rem!important}"
+"a:focus-visible,button:focus-visible,.premium-btn:focus-visible,#dg-bar a:focus-visible{outline:2px solid #1F4B99!important;outline-offset:3px!important}"
+"@media(max-width:767px){#dg-path-pills{display:none!important}.hero-actions{display:none!important}#dg-bar{position:fixed!important;left:0;right:0;bottom:0;z-index:9998;display:grid!important;grid-template-columns:1fr 1fr;gap:8px;padding:10px 12px calc(10px + env(safe-area-inset-bottom,0px))!important;background:rgba(247,244,239,.97)!important;border-top:1px solid #e4ddd3!important}#dg-bar a{min-width:0!important;min-height:48px!important;border-radius:14px!important;font-size:.9rem!important;font-weight:650!important;padding:.65rem .5rem!important;display:flex!important;align-items:center!important;justify-content:center!important;text-decoration:none!important}body{padding-bottom:calc(72px + env(safe-area-inset-bottom,0px))!important}.steps-grid{grid-template-columns:1fr!important}.hero-section h1,.header h1{font-size:clamp(2rem,9vw,2.75rem)!important}#dg-path-pills{justify-content:flex-start}}"
...
window.__dgFootVer='581';console.log('Demigod v581');
