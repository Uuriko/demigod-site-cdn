 ...
 */
window.dgFootVersion = 'v497'; console.log('[demigod] foot v497-core loaded');
(function(){
...
function scrubContactEmail(){
  try{
    ...
    qa('meta[content]').forEach(function(m){
      var c=m.getAttribute('content')||'';
      if(bad.test(c)){ bad.lastIndex=0; m.setAttribute('content',c.replace(bad,good)); }
    });
  }catch(e){}
}
...
window.__dgFootVer='497';console.log('Demigod v497');
