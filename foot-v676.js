 ...
 */
window.dgFootVersion = 'v676'; console.log('[demigod] foot v676-core loaded');
(function(){
...
function hero(){
  qa('.hero-section h1,.hero-title,.header h1').forEach(function(e){
    // Dual-path H1 (not CTA "I'm hiring"). Mark locked so honesty scrubs never rewrite "Find talent" → "I'm hiring".
    e.setAttribute('data-dg-hero-h1','1');
    e.innerHTML='Find talent.<br><em class="dg-em">Find startups.</em>';
  });
...
+"body.dg-ready .hero-actions .dg-cta-wrap.dg-in a[data-dg-cta=hire] .dg-cta-label,body[data-dg-ready=\"1\"] .hero-actions .dg-cta-wrap.dg-in a[data-dg-cta=hire] .dg-cta-label{animation:dgCtaPhosphor 1.55s cubic-bezier(.16,1,.3,1) var(--d,0ms) both}"
...
window.__dgFootVer='676';console.log('Demigod v676');
