 ...
 */
window.dgFootVersion = 'v212'; console.log('[demigod] foot v212-core loaded');
(function(){
...
var COPY={
heroSub:'SF startups and talent. Human match. Mutual yes. 10% only when you hire.',
badge:'SF · HUMAN-MATCHED',
heroTrustLine:'Mutual yes · 10% on hire · Not a job board',
...
window.__dgFootVer='212';console.log('Demigod v212');
