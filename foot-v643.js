 ...
 */
window.dgFootVersion = 'v643'; console.log('[demigod] foot v643-core loaded');
(function(){
...
/** Race health across all bases; first OK wins (fixes Draft mode when first host is dead). */
...
window.__dgFootVer='643';console.log('Demigod v643');
