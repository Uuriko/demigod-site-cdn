 ...
 */
window.dgFootVersion = 'v674'; console.log('[demigod] foot v674-core loaded');
(function(){
...
function scrubStaticLabels(){
  ...
  function honestStaticCopy(t){
    ...
    if(staleHire.test(out) && !/^Find talent(?:\.\s*Find startups\.?)?$/i.test(out))return "I'm hiring";
...
window.__dgFootVer='674';console.log('Demigod v674');
