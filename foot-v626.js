 ...
 */
window.dgFootVersion = 'v626'; console.log('[demigod] foot v626-core loaded');
(function(){
...
/* v626: green Olympic torch — flame + cup + handle */
function ensureLogo(){
  try{
    var mark='<svg class="dg-mark" data-v="626" width="28" height="28" viewBox="0 0 32 32" aria-hidden="true" focusable="false"><rect width="32" height="32" rx="8" fill="#03140d"/><path fill="#a6ffcb" d="M16 3c2.2 2.4 4.5 4.2 4.5 7.2 0 2.6-2 4.6-4.5 4.6S11.5 12.8 11.5 10.2C11.5 7.2 13.8 5.4 16 3z"/><path fill="#10c674" d="M16 7.2c1.1 1.2 2 2.1 2 3.4 0 1.2-.9 2.1-2 2.1s-2-.9-2-2.1c0-1.3.9-2.2 2-3.4z"/><path fill="#10c674" d="M9 15h14l-1.5 4.5H10.5L9 15z"/><rect x="13.5" y="19" width="5" height="10" rx="1.2" fill="#a6ffcb"/></svg>';
    qa('a.nav_logo,.nav_logo,a.w-nav-brand,a.logo-link,.logo-link,.w-nav-brand').forEach(function(a){
      ...
      if(a.querySelector('svg.dg-mark[data-v="626"]')){a.dataset.dgMark='626';return;}
      a.dataset.dgMark='626';
    ...
    if(document.documentElement.dataset.dgFav!=='626'){
      document.documentElement.dataset.dgFav='626';
      try{
        var href='data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20viewBox%3D%220%200%2032%2032%22%3E%3Crect%20width%3D%2232%22%20height%3D%2232%22%20rx%3D%228%22%20fill%3D%22%2303140d%22/%3E%3Cpath%20fill%3D%22%23a6ffcb%22%20d%3D%22M16%203c2.2%202.4%204.5%204.2%204.5%207.2%200%202.6-2%204.6-4.5%204.6S11.5%2012.8%2011.5%2010.2C11.5%207.2%2013.8%205.4%2016%203z%22/%3E%3Cpath%20fill%3D%22%2310c674%22%20d%3D%22M16%207.2c1.1%201.2%202%202.1%202%203.4%200%201.2-.9%202.1-2%202.1s-2-.9-2-2.1c0-1.3.9-2.2%202-3.4z%22/%3E%3Cpath%20fill%3D%22%2310c674%22%20d%3D%22M9%2015h14l-1.5%204.5H10.5L9%2015z%22/%3E%3Crect%20x%3D%2213.5%22%20y%3D%2219%22%20width%3D%225%22%20height%3D%2210%22%20rx%3D%221.2%22%20fill%3D%22%23a6ffcb%22/%3E%3C/svg%3E';
...
window.__dgFootVer='626';console.log('Demigod v626');
