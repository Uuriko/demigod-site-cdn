 ...
 */
window.dgFootVersion = 'v653'; console.log('[demigod] foot v653-core loaded');
(function(){
...
function openPage(id, push) {
  ...
  try {
    var KEEP = /^(90-day-outcomes|both-approve|ten-percent|private-match-notes|human-review-over-volume|sf-events-calendar|when-not-to-intro|no-public-talent-feed|match-note-anti-patterns)$/;
...
function deepLink(){
  ...
  try{
    ...
    if(/^note-/.test(h)||/^(90-day-outcomes|both-approve|ten-percent|private-match-notes|human-review-over-volume|sf-events-calendar|when-not-to-intro|no-public-talent-feed|match-note-anti-patterns)$/.test(h)){ openPage('blog',false); window.__dgDeepLinked=1; return; }
    if(!w)return;
    var open=function(){
...
window.__dgFootVer='653';console.log('Demigod v653');
