/*dg-foot-v892-core*/
window.dgFootVersion = 'v892'; console.log('[demigod] foot v892-core loaded');
(function(){
...
var COPY={
heroSub:'Start with one role, real constraints, and one concrete first result. '+MATCH_DISCLOSURE+' Candidate identity stays private until both sides say yes.',
...
var WIZ_CFG={
  ...
  engineer:{
    ...
    welcome:{t:'Join the talent network',b:'For people open to SF Bay startup roles. About 2 minutes · private intent (not a public profile) · free forever · no blasts. Already joined? Submit again with the same email; a human reviews the update. Shared only after you approve an intro. Press Enter to continue.',btn:'Start my profile'},
    thanks:ENGINEER_OK,
    optional:['quiet-mode']
  }
};
...
var DG_PAGES = {
  how: {
    ...
    html:
      '<p class="dg-p-lead">A match has three gates. The startup authorizes a pitch; the candidate sees the company and exact role; candidate identity and contact details move only after both say yes.</p>' +
      '<ol class="dg-p-list">' +
      ...
      '<li><strong>Startup requests → candidate decides → intro</strong> — the candidate gets the exact role receipt first and can pass privately. A warm intro email only when both say yes. Fee is 10% of first-year base salary when a hire starts.</li>' +
      '</ol>' +
...
window.__dgFootVer='892';console.log('Demigod v892');
