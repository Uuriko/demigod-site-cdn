/*dg-foot-v880-core*/
window.dgFootVersion = 'v880'; console.log('[demigod] foot v880-core loaded');
(function(){
...
var WIZ_THANKS={
  startup:{head:'Brief in',lead:'Someone reads every submission. We only propose when the fit is real — both sides still have to say yes.',steps:['We read the role, success profile, and constraints','Software compares; a human proposes','You approve before any intro']},
...
var WIZ_CFG={
  startup:{
    ...
    welcome:{t:'Hiring brief',b:'About 2 minutes · one question at a time. Role, success, real constraints. Press Enter to continue.',btn:'Start the brief'},
    thanks:STARTUP_OK,
    optional:[]
  },
  engineer:{
...
var WIZ_Q={
  startup:{
    ...
    '__submit__':{q:'Look good?',h:'Edit any answer below. We process this for matching only — names move only after both sides approve. No spam lists.'}
  },
  engineer:{
...
function hero(){
  ...
  qa('.step-card').forEach(function(card,i){
    ...
    var steps=[
      ...
      ['Compare, then review','Software compares outcomes and constraints. A human decides what to propose.'],
...
var DG_PAGES = {
  how: {
    ...
    html:
      ...
      '<li><strong>Software compares; a human decides</strong> — outcomes, skills, location, and compensation are compared. A person reviews the evidence and decides what to propose. Nothing is sent automatically.</li>' +
  ...
  faq: {
    title: 'FAQ',
    doc: 'FAQ · Demigod',
    desc: 'Answers about Demigod’s SF matching, submissions, 10% success fee, free talent profiles, privacy, 90-day outcomes, and mutual intros.',
    html:
  ...
  hire: {
    ...
    html:
      ...
      '<li><strong>Software compares, a human reviews</strong> — against the outcome and real constraints. Nothing is sent automatically.</li>' +
  ...
  legal: {
    ...
    html:
      ...
      '<h2 class="dg-p-h3">Terms</h2><p>Demigod introduces parties; employment decisions are yours. Placement fee is 10% of first-year base salary, excluding equity, discretionary bonus, commission, and benefits, when a hire starts (unless written otherwise). Payments tooling is pending — commercial confirmations by email. SF Bay Area focus. No SLA promises on response time.</p>',
  },
  refer: {
  ...
  sample: {
    ...
    html:
      '<p class="dg-p-lead"><strong>Fictional examples.</strong> Before either side decides, the candidate sees the same role receipt: outcome, must-haves, work arrangement, and base range. These are not live people, roles, or placements.</p>' +
...
window.__dgFootVer='880';console.log('Demigod v880');
