/*dg-foot-v854-core*/
window.dgFootVersion = 'v854'; console.log('[demigod] foot v854-core loaded');
(function(){
    ...
    panel.innerHTML=
      ...
      '<nav id="dg-legal-links" aria-label="Footer navigation">'+
        ...
        '<div class="dg-footer-group" role="group" aria-labelledby="dg-footer-explore">'+
          ...
          '<a href="/?p=press" data-dg-page="press">Press kit</a>'+
...
function dgMapEventsHtml(kind){
  ...
  var lead=isEvents
    ?'<div class="dg-ev-hero" aria-hidden="true"></div>'+
      ...
      '</ul>'+
      '<p class="dg-p-note">Companies → <a href="/?p=map" data-dg-page="map">SF startup directory</a>.</p>'
...
var DG_PAGES = {
  ...
  refer: {
    ...
    html:
      ...
      '<div id="dg-referral-form-slot"></div>',
  },
  about: {
    title: 'About',
    doc: 'About · Demigod',
  ...
  notfound: {
    ...
    html:
      ...
      '<li><a href="/?p=how" data-dg-page="how">How it works</a></li>' +
      '<li><a href="/?p=hire" data-dg-page="hire">Hire talent</a></li>' +
      '<li><a href="/?p=talent" data-dg-page="talent">Join the talent network</a></li>' +
      '<li><a href="/?p=events" data-dg-page="events">SF events</a></li>' +
      '</ul>',
  },
  press: {
    title: 'Press kit',
...
function openPage(id, push) {
  ...
  try {
    ...
    var preferred = { how:'/how', pricing:'/pricing', hire:'/hire', talent:'/talent', faq:'/faq', legal:'/legal', refer:'/refer', partners:'/partners', about:'/about', events:'/events', map:'/map', contact:'/contact', blog:'/blog', sample:'/sample', compare:'/compare', status:'/status', event:'/event', press:'/press', notfound:'/' };
...
window.__dgFootVer='854';console.log('Demigod v854');
