 ...
 */
window.dgFootVersion = 'v566'; console.log('[demigod] foot v566-core loaded');
(function(){
...
function hero(){
  qa('.hero-section h1,.hero-title,.header h1').forEach(function(e){
    e.innerHTML='<span class="title-accent-gold">SF startups,</span> <span class="title-accent-cream">matched by hand.</span>';
  });
...
window.__dgFootVer='566';console.log('Demigod v566');
