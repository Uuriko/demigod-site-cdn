 ...
 */
window.dgFootVersion = 'v731'; console.log('[demigod] foot v731-core loaded');
(function(){
...
function pageCss() {
  ...
  s.textContent =
    ...
    '#dg-page:not(.dg-blog-reading) .dg-blog-card:only-child>.dg-blog-more[open]{max-width:68ch;width:calc(100% - 1.8rem);margin:1rem auto 1.5rem}' +
...
window.__dgFootVer='731';console.log('Demigod v731');
