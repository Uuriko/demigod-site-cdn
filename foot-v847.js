/*dg-foot-v847-core*/
window.dgFootVersion = 'v847'; console.log('[demigod] foot v847-core loaded');
(function(){
...
function dgMapEventsHtml(kind){
  ...
  return lead+listings+'<section class="dg-community-submit" aria-labelledby="dg-community-title"><h2 id="dg-community-title" class="dg-p-h3">Submit</h2>'+submitLead+'<div class="dg-submit-grid">'+forms+manageHtml+'</div>'+footNote+'</section>';
}
...
window.__dgFootVer='847';console.log('Demigod v847');
