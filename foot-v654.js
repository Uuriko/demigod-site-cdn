 ...
 */
window.dgFootVersion = 'v654'; console.log('[demigod] foot v654-core loaded');
(function(){
...
var DG_BLOG_POSTS=[{"slug":"90-day-outcomes","category":"Product","title":"Why 90-day outcomes beat keyword JDs","summary":"Match on a measurable first-quarter result, not a stack laundry list.","body":"Keyword filters flood both sides with false matches. One measurable 90-day outcome creates a shared decision frame before identities move: what ships, what proof counts, and what would make either side pass. Stack laundry lists can wait until both sides have already opted into a real conversation.","image":"https://files.catbox.moe/urbco5.jpg","imageAlt":"Gold-on-dark abstract mark for 90-day outcome matching note","publishedAt":"2026-07-16"},{"slug":"both-approve","category":"Privacy","title":"Both sides approve before intros","summary":"Evidence first. Contact details only after founder and talent both opt in.","body":"Profiles stay private. Evidence packets move first: outcome, proof, constraints, and one open gap. Contact details move only when founder and talent both approve — no public talent feed, no cold blasts. That is slower than a public board and faster at real decisions — trust over volume. Follow-ups use potter@trydemigod.com — not a public talent feed.","image":"https://files.catbox.moe/wewe5r.jpg","imageAlt":"Private match approval path illustration — both sides opt in","publishedAt":"2026-07-16"},{"slug":"ten-percent","category":"Pricing","title":"10% on hire, free for talent","summary":"10% of first-year cash on hire. Free for talent. No retainers.","body":"Agencies often sit at 15–25% plus retainers. Demigod charges 10% of first-year cash only when a hire starts. Talent never pays. No subscription to browse people; commercial follow-up is email (potter@trydemigod.com) while card tooling stays pending.","image":"https://files.catbox.moe/eg561c.jpg","imageAlt":"Simple 10% hire fee diagram on dark gold brand field","publishedAt":"2026-07-16"},{"slug":"private-match-notes","category":"Product","title":"What belongs in a private match note","summary":"The smallest useful packet: proof, constraints, one evidence gap, and a private yes or pass.","body":"A private match note is the smallest packet that lets both sides decide without exposing identities. Keep it tight: (1) one measurable 90-day outcome, (2) proof the candidate can ship that outcome, (3) hard constraints (location, comp band, visa, hours), (4) one explicit evidence gap, and (5) a private yes/pass from the reviewer. Skip stack laundry lists and culture fluff. If the note cannot support a clear yes or pass, it is not ready to move.","image":"https://files.catbox.moe/i4j3y0.jpg","imageAlt":"Compact private match-note packet sketch","publishedAt":"2026-07-16"},{"slug":"human-review-over-volume","category":"Market","title":"Human review over application volume","summary":"No fixed candidate-count promise — evidence-backed intros only.","body":"No fixed candidate-count promise. Public application floods hide signal. A human-reviewed shortlist, grounded in a 90-day outcome and real proof, can save both sides weeks. Volume is not the product — evidence-backed intros only.","image":"https://files.catbox.moe/zhxopd.jpg","imageAlt":"Human review shortlist over volume flood — brand visual","publishedAt":"2026-07-16"},{"slug":"sf-events-calendar","category":"Product","title":"SF Events Bot calendar — multiple nights, same day","summary":"Park sponsorable SF nights on a real calendar. Multiple events can share a date.","body":"Events Bot is not only for Demigod-branded dinners. Hosts can schedule fun SF nights, keep multiple events on the same day, and take sponsor / venue / volunteer offers without auto-blast. The calendar on /?p=events is the working surface; autonomy stays draft until you send.","image":"https://files.catbox.moe/urbco5.jpg","imageAlt":"Gold calendar motif for SF Events Bot nights","publishedAt":"2026-07-17"},{"slug":"when-not-to-intro","category":"Product","title":"When not to intro","summary":"A clean pass protects both sides. Forced intros are how matching products lose trust.","body":"A good matching product needs a stop button.\n\nNot a polite delay. A real pass: this packet does not clear the bar, so we do not move names. That feels cold when you're hiring under pressure. It's still kinder than a warm intro that neither side can honestly want.\n\nHere's the quiet failure mode we care about. Someone sends a stack list and a vibe. No 90-day outcome. No proof. One side is \"open to chat.\" The other is \"looking at options.\" That's not a decision. That's calendar damage.\n\nWe only advance when the private packet can support a yes or a no. Outcome. Proof. Constraints. One open gap. If the gap is fatal—wrong city, wrong cash band, no path to the outcome—we stop. Talent stays private. Founder doesn't burn a coffee on a maybe.\n\nTradeoff is obvious. You get fewer intros than a spray-and-pray board. You also get fewer zombie threads.\n\nWe don't invent urgency to fill a week. We don't promise a fixed number of candidates. Commercial follow-up is email to potter@trydemigod.com. If you're stuck mid-packet, say what evidence is missing. That's useful. \"Just intro us\" usually isn't.","image":"https://files.catbox.moe/wewe5r.jpg","imageAlt":"Private approval path — both sides opt in or stop","publishedAt":"2026-07-17"},{"slug":"no-public-talent-feed","category":"Privacy","title":"Why we won’t ship a public talent feed","summary":"A browsable candidate directory trains spam. Demigod keeps profiles private and moves evidence first.","body":"People ask for a \"talent marketplace.\" They mean a grid of profiles you can skim like inventory.\n\nWe won't build that.\n\nPublic feeds change incentives. Founders blast. Recruiters scrape. Talent gets noise and learns to ghost. Privacy becomes theater—a toggle nobody trusts.\n\nDemigod runs the other direction. Profiles stay private. What moves first is a small packet: a measurable outcome, proof someone can ship it, hard constraints, one gap. Contact details move only after founder and talent both approve. Slow at the top. Faster once both sides have already decided the chat is worth it.\n\nYes, that means you cannot \"browse our network\" like a catalog. Good. Catalogs are how you get volume theater.\n\nTalent never pays. Hire fee is 10% of first-year cash if a hire starts—no retainer to unlock a feed that shouldn't exist. Card tooling is still pending; email is the path: potter@trydemigod.com.\n\nIf you need volume theater, other products sell it. If you need a mutual yes without lighting up inboxes, start with the packet—not a directory.","image":"https://files.catbox.moe/i4j3y0.jpg","imageAlt":"Compact private match-note packet","publishedAt":"2026-07-17"},{"slug":"match-note-anti-patterns","category":"Ops","title":"Five ways a match note fails","summary":"Most weak notes die the same deaths. Fix the note before you ask for an intro.","body":"You can smell a bad match note in the first two lines.\n\n1. Stack laundry, no outcome. \"React, systems, ownership\" is not a decision. What ships in 90 days?\n\n2. Culture fog. \"High agency, low ego\" without a constraint or a proof point. Nice. Not actionable.\n\n3. Hidden deal-breakers. Visa, city, cash floor, hours—if they show up after names move, you wasted trust.\n\n4. No gap. Every note needs one honest hole. \"We haven't seen X yet.\" Reviewers need that.\n\n5. Ask for identity first. If the note only works after LinkedIn opens, it isn't a note. It's a cold outbound script.\n\nA passable packet is small on purpose: outcome, proof, constraints, one gap, private yes/pass. If you can't yes or pass from that, don't request an intro. Tighten the note.\n\nWe won't dress a weak packet as a \"hot candidate.\" Mutual approval exists so neither side gets trapped by charm.\n\nSend the boring version to potter@trydemigod.com. Boring is fine. Vague is expensive.","image":"https://files.catbox.moe/zhxopd.jpg","imageAlt":"Human review over volume — shortlist not flood","publishedAt":"2026-07-17"},{"slug":"first-year-cash-not-equity-fog","category":"Pricing","title":"Put the cash number in the note","summary":"Demigod’s 10% is on first-year cash. Equity-heavy packages need that constraint on the page before anyone shares a name.","body":"If the packet only says \"competitive package,\" stop.\n\nOur fee is simple on purpose: 10% of first-year cash when a hire starts. Talent pays nothing. No retainer to peek at people. Card capture is still pending, so commercial follow-up is email — potter@trydemigod.com.\n\nEquity complicates feelings, not the definition. A role can be cash-light and equity-heavy. Fine. Write the cash floor (or the honest range) in the private note before identities move. If you hide it, both sides waste a call negotiating a number that should have been a constraint.\n\nWe won't invent a \"total comp\" fairy tale for you. Cap tables differ. Refresh schedules differ. What we will do is refuse to treat \"meaningful equity\" as a substitute for a number someone can plan rent around.\n\nTradeoff: some founders would rather stay vague longer. Vague is cheaper socially. It's expensive in trust.\n\nTalent side: if cash is non-negotiable for you, say so in the profile notes. Better a clean pass than a charming intro into a wall.","image":"https://files.catbox.moe/eg561c.jpg","imageAlt":"Simple hire-fee sketch on dark gold field","publishedAt":"2026-07-17"},{"slug":"what-talent-sees","category":"Product","title":"What talent should see before approving","summary":"Mutual approve is empty if talent only gets a brand story. Show the outcome, constraints, and the gap.","body":"Mutual approval only works if both sides review something real.\n\nFounders sometimes want talent to \"just hop on a call.\" Talent sometimes wants the company mythos and a founder bio. Neither is a decision packet.\n\nWhat talent should see, without a public profile grid: the 90-day outcome you're hiring for, the proof bar, constraints that actually bind (city, hours, visa, cash band), and one honest gap (\"we haven't seen production ownership at this scale yet\"). Names stay back until both sides say yes.\n\nThat's slower than a job post with a logo. It also means fewer intros that die in week one.\n\nWe don't run a browsable talent feed. We also don't ask talent to approve a fog machine. If the note can't support a pass, it can't support an approve either.\n\nSend the boring version. potter@trydemigod.com. If you're talent, ask for the outcome in writing before you opt in. That's not picky. That's the product working.","image":"https://files.catbox.moe/wewe5r.jpg","imageAlt":"Two-sided private approval path","publishedAt":"2026-07-17"},{"slug":"sf-night-is-not-a-pipeline-hack","category":"Market","title":"An SF night is not a stealth pipeline","summary":"Events Bot is for real San Francisco nights. If the only goal is scraping leads, don’t host.","body":"You can put two events on the same calendar day. You cannot turn a dinner into a covert CRM import and call it community.\n\nEvents Bot is SF-only, in-person, on purpose. Hosts chat, park dates, take sponsor/venue/volunteer offers. Autonomy stays draft. No auto-DM. SMS and calendar sync are still pending. Follow-up is human.\n\nThe failure mode is familiar: invite people under a fun frame, then spray-recruit in the thank-you email. That burns the room and the brand in one move.\n\nTradeoff if you host cleanly: you spend real effort on a night that might not convert to intros. That's fine. Trust compounds slower than a lead magnet and dies faster when faked.\n\nIf you want a recruiting channel, say so and use the matching path. If you want a night, host a night — clear frame, clear ask, no bait.\n\nCalendar lives at /?p=events. Questions: potter@trydemigod.com.","image":"https://files.catbox.moe/urbco5.jpg","imageAlt":"Gold mark for SF nights and calendars","publishedAt":"2026-07-17"}];
var DG_PAGES = {
  how: {
    title: 'How it works',
  ...
  blog: {
    ...
    html:
      ...
      '</div>' +
      '<div class="dg-blog-filters" id="dg-blog-filters" role="tablist" aria-label="Blog categories"></div>' +
...
'<p class="dg-p-note">Play solo in the browser. SF startup names are flavor only.</p>',
  ...
  events: {
    ...
    html:
      ...
      '<div class="dg-ev-cal-grid" id="dg-ev-cal-grid" role="grid" aria-labelledby="dg-ev-cal-month"></div>' +
...
function pageCss() {
  ...
  s.textContent =
    ...
    '#dg-page .dg-blog-chip{min-height:40px;padding:.4rem .85rem;border-radius:999px;border:1px solid rgba(201,168,76,.35);background:transparent;color:#E8D5A3;font:650 .82rem Manrope,system-ui,sans-serif;cursor:pointer}' +
...
function openPage(id, push) {
  ...
  try {
    var KEEP = /^(90-day-outcomes|both-approve|ten-percent|private-match-notes|human-review-over-volume|sf-events-calendar|when-not-to-intro|no-public-talent-feed|match-note-anti-patterns|first-year-cash-not-equity-fog|what-talent-sees|sf-night-is-not-a-pipeline-hack)$/;
...
function deepLink(){
  ...
  try{
    ...
    if(/^note-/.test(h)||/^(90-day-outcomes|both-approve|ten-percent|private-match-notes|human-review-over-volume|sf-events-calendar|when-not-to-intro|no-public-talent-feed|match-note-anti-patterns|first-year-cash-not-equity-fog|what-talent-sees|sf-night-is-not-a-pipeline-hack)$/.test(h)){ openPage('blog',false); window.__dgDeepLinked=1; return; }
    if(!w)return;
    var open=function(){
...
window.__dgFootVer='654';console.log('Demigod v654');
