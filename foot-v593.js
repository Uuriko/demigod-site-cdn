 ...
 */
window.dgFootVersion = 'v593'; console.log('[demigod] foot v593-core loaded');
(function(){
...
/* Art: hero/aperture still on litter 72h until gh/catbox permanent recovers (Fable P0 partial).
   Grain is pure CSS — no remote fuse for body overlay. */
var DG_ART={
  hero:'https://litter.catbox.moe/q323xf.jpg',
  aperture:'https://litter.catbox.moe/u34p8a.jpg'
};
...
window.__dgFootVer='593';console.log('Demigod v593');
