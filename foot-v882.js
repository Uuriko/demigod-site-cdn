/*dg-foot-v882-core*/
window.dgFootVersion = 'v882'; console.log('[demigod] foot v882-core loaded');
(function(){
...
var WIZ_CFG={
  startup:{
    ...
    welcome:{t:'Hiring brief',b:'About 2 minutes · 10% of first-year base only if you hire · nothing upfront. Press Enter to continue.',btn:'Start the brief'},
    thanks:STARTUP_OK,
    optional:[]
  },
  engineer:{
...
window.__dgFootVer='882';console.log('Demigod v882');
