 ...
 */
window.dgFootVersion = 'v627'; console.log('[demigod] foot v627-core loaded');
(function(){
...
/* v627: Olympic torch (Fable) — asymmetric flame, rim, tapered handle */
function ensureLogo(){
  try{
    var mark='<svg class="dg-mark" data-v="627" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 32 32" aria-hidden="true" focusable="false"> <rect width="32" height="32" rx="8" fill="#03140d"/> <path fill="#a6ffcb" d="M17.4 2.6C15 4.8 11.6 6.8 11.6 10.2a4.5 4.5 0 0 0 9 0c0-2-.9-3.3-1.9-4.6-.7-.9-1.3-1.9-1.3-3z"/> <path fill="#10c674" d="M16.5 7.5c1 1.1 1.9 2 1.9 3.3a2.1 2.1 0 1 1-4.2 0c0-1.3 1.2-2.2 2.3-3.3z"/> <rect x="9" y="14" width="14" height="2.4" rx="1.2" fill="#a6ffcb"/> <path fill="#10c674" d="M10.4 16.4h11.2l-1.7 3.8h-7.8l-1.7-3.8z"/> <path fill="#a6ffcb" d="M12.4 20.2h7.2l-2.1 8a1.6 1.6 0 0 1-3 0l-2.1-8z"/> </svg>';
    qa('a.nav_logo,.nav_logo,a.w-nav-brand,a.logo-link,.logo-link,.w-nav-brand').forEach(function(a){
      ...
      if(a.querySelector('svg.dg-mark[data-v="627"]')){a.dataset.dgMark='627';return;}
      a.dataset.dgMark='627';
    ...
    if(document.documentElement.dataset.dgFav!=='627'){
      document.documentElement.dataset.dgFav='627';
      try{
        var href='data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2232%22%20height%3D%2232%22%20viewBox%3D%220%200%2032%2032%22%3E%20%3Crect%20width%3D%2232%22%20height%3D%2232%22%20rx%3D%228%22%20fill%3D%22%2303140d%22/%3E%20%3Cpath%20fill%3D%22%23a6ffcb%22%20d%3D%22M17.4%202.6C15%204.8%2011.6%206.8%2011.6%2010.2a4.5%204.5%200%200%200%209%200c0-2-.9-3.3-1.9-4.6-.7-.9-1.3-1.9-1.3-3z%22/%3E%20%3Cpath%20fill%3D%22%2310c674%22%20d%3D%22M16.5%207.5c1%201.1%201.9%202%201.9%203.3a2.1%202.1%200%201%201-4.2%200c0-1.3%201.2-2.2%202.3-3.3z%22/%3E%20%3Crect%20x%3D%229%22%20y%3D%2214%22%20width%3D%2214%22%20height%3D%222.4%22%20rx%3D%221.2%22%20fill%3D%22%23a6ffcb%22/%3E%20%3Cpath%20fill%3D%22%2310c674%22%20d%3D%22M10.4%2016.4h11.2l-1.7%203.8h-7.8l-1.7-3.8z%22/%3E%20%3Cpath%20fill%3D%22%23a6ffcb%22%20d%3D%22M12.4%2020.2h7.2l-2.1%208a1.6%201.6%200%200%201-3%200l-2.1-8z%22/%3E%20%3C/svg%3E';
...
window.__dgFootVer='627';console.log('Demigod v627');
