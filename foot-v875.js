/*dg-foot-v875-core*/
window.dgFootVersion = 'v875'; console.log('[demigod] foot v875-core loaded');
(function(){
...
function dgEventsBotLoadConfig() {
  ...
  // Prefer raw GitHub only: jsDelivr @main lags for days and pollutes fallback bases with dead tunnels.
  var urls = [
...
var DG_PAGES = {
  how: {
    ...
    desc: 'How Demigod works: share a brief or profile, software ranks fit, humans review, and both sides approve before an intro. 10% on hire; talent free.',
    html:
...
window.__dgFootVer='875';console.log('Demigod v875');
