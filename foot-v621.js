 ...
 */
window.dgFootVersion = 'v621'; console.log('[demigod] foot v621-core loaded');
(function(){
...
/* v621: ensureLogo must run from run()/boot — v620 defined it but never called */
function ensureLogo(){
  try{
    ...
    qa('a.nav_logo,.nav_logo,a.w-nav-brand,a.logo-link,.logo-link,.w-nav-brand').forEach(function(a){
      ...
      if(a.querySelector('svg.dg-mark')){a.dataset.dgMark='1';return;}
      a.dataset.dgMark='1';
    ...
    // favicon once (head may lag; runtime override)
    if(document.documentElement.dataset.dgFav!=='1'){
      document.documentElement.dataset.dgFav='1';
      try{
...
window.__dgFootVer='621';console.log('Demigod v621');
