/*dg-foot-v857-core*/
window.dgFootVersion = 'v857'; console.log('[demigod] foot v857-core loaded');
(function(){
...
function hero(){
  ...
  if(host&&!q('#dg-path-pills')){
    ...
    pills.innerHTML=
      ...
      '<a href="/map" data-dg-page="map">'+COPY.pathStartups+'</a>';
...
function dgMapEventsHtml(kind){
  ...
  var lead=isEvents
    ?'<div class="dg-ev-hero" aria-hidden="true"></div>'+
      ...
      '</ul>'+
      '<p class="dg-p-note">Companies → <a href="/map" data-dg-page="map">SF startup directory</a>.</p>'
...
window.__dgFootVer='857';console.log('Demigod v857');
