/*dg-foot-v883-core*/
window.dgFootVersion = 'v883'; console.log('[demigod] foot v883-core loaded');
(function(){
...
var DG_PAGES = {
  ...
  talent: {
    ...
    html:
      ...
      '</ul>' +
      '<p class="dg-p-note">No board spam or cold-LinkedIn blasts. What we ask: strengths, a couple of work highlights, availability, and a cash band — enough to match against success by day 90, not keywords. <a href="/how" data-dg-page="how">How it works →</a> · <a href="/faq" data-dg-page="faq">FAQ →</a></p>',
  },
  contact: {
    title: 'Contact',
    doc: 'Contact · Demigod',
...
window.__dgFootVer='883';console.log('Demigod v883');
