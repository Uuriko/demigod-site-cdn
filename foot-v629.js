 ...
 */
window.dgFootVersion = 'v629'; console.log('[demigod] foot v629-core loaded');
(function(){
...
/* v629: Kouros (Fable) — Greek profile bust on signal plinth */
function ensureLogo(){
  try{
    var mark='<svg class="dg-mark" data-v="629" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="28" height="28" aria-hidden="true" focusable="false"> <rect width="32" height="32" rx="8" fill="#03140d"/> <path fill="#10c674" d="M8 24.5h16v2.3a1.2 1.2 0 0 1-1.2 1.2H9.2A1.2 1.2 0 0 1 8 26.8Z"/> <path fill="#a6ffcb" d="M16.4 4.2C19.2 4.4 20.6 6.4 20.8 9L21.4 11L24.2 15.8L20.8 16.1C21.8 16.8 21.8 17.6 21 17.9C22 18.4 22 19.6 20.9 20.2C20.2 20.7 19.6 20.8 19.2 20.8L19.2 22.4C21.2 22.9 22.4 23.6 22.9 24.5L10 24.5C10.6 23.4 11.7 22.7 13.2 22.4L13.2 18.2C10.6 16.8 9.6 14.6 9.6 12.2C9.6 7.2 12.6 4.2 16.4 4.2Z"/> <path fill="#03140d" d="M17.6 11.3q1.6-.7 2.9-.1q-1.4 1.1-2.9.1Z"/> </svg>';
    qa('a.nav_logo,.nav_logo,a.w-nav-brand,a.logo-link,.logo-link,.w-nav-brand').forEach(function(a){
      ...
      if(a.querySelector('svg.dg-mark[data-v="629"]')){a.dataset.dgMark='629';return;}
      a.dataset.dgMark='629';
    ...
    if(document.documentElement.dataset.dgFav!=='629'){
      document.documentElement.dataset.dgFav='629';
      try{
        var href='data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20viewBox%3D%220%200%2032%2032%22%20width%3D%2232%22%20height%3D%2232%22%3E%20%3Crect%20width%3D%2232%22%20height%3D%2232%22%20rx%3D%228%22%20fill%3D%22%2303140d%22/%3E%20%3Cpath%20fill%3D%22%2310c674%22%20d%3D%22M8%2024.5h16v2.3a1.2%201.2%200%200%201-1.2%201.2H9.2A1.2%201.2%200%200%201%208%2026.8Z%22/%3E%20%3Cpath%20fill%3D%22%23a6ffcb%22%20d%3D%22M16.4%204.2C19.2%204.4%2020.6%206.4%2020.8%209L21.4%2011L24.2%2015.8L20.8%2016.1C21.8%2016.8%2021.8%2017.6%2021%2017.9C22%2018.4%2022%2019.6%2020.9%2020.2C20.2%2020.7%2019.6%2020.8%2019.2%2020.8L19.2%2022.4C21.2%2022.9%2022.4%2023.6%2022.9%2024.5L10%2024.5C10.6%2023.4%2011.7%2022.7%2013.2%2022.4L13.2%2018.2C10.6%2016.8%209.6%2014.6%209.6%2012.2C9.6%207.2%2012.6%204.2%2016.4%204.2Z%22/%3E%20%3Cpath%20fill%3D%22%2303140d%22%20d%3D%22M17.6%2011.3q1.6-.7%202.9-.1q-1.4%201.1-2.9.1Z%22/%3E%20%3C/svg%3E';
...
window.__dgFootVer='629';console.log('Demigod v629');
