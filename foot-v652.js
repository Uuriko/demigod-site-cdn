 ...
 */
window.dgFootVersion = 'v652'; console.log('[demigod] foot v652-core loaded');
(function(){
...
function deepLink(){
  ...
  try{
    ...
    if(/^note-/.test(h)||/^(90-day-outcomes|both-approve|ten-percent|private-match-notes|human-review-over-volume|sf-events-calendar)$/.test(h)){ openPage('blog',false); window.__dgDeepLinked=1; return; }
    if(!w)return;
    var open=function(){
...
window.__dgFootVer='652';console.log('Demigod v652');
