/*dg-foot-v899-core*/
window.dgFootVersion = 'v899'; console.log('[demigod] foot v899-core loaded');
(function(){
...
var DG_PAGES = {
  how: {
    ...
    desc: 'Share one role or private profile. A human calibrates the fit, both sides opt in, and Demigod follows the next checkpoint through a hire or clear pass.',
    html:
      ...
      '<li><strong>Interview directly</strong> — after both say yes, a warm intro puts the startup and candidate together. The startup runs its interview; Demigod follows the agreed next checkpoint through interview, offer, hire, or a clear pass.</li>' +
...
window.__dgFootVer='899';console.log('Demigod v899');
