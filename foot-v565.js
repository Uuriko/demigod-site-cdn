 ...
 */
window.dgFootVersion = 'v565'; console.log('[demigod] foot v565-core loaded');
(function(){
...
var COPY={
heroSub:'A human connects you — only if you both say yes.',
badge:'SF Bay Area',
  ...
  qa('section').forEach(function(s){
    ...
    if(/LIVE ROLES|Example roles|example role/i.test(sniff) && s.querySelector('.roles-grid,.role-card')){
      ...
      if(!q('#dg-roles-empty')){
        ...
        note.textContent='No live roles listed yet — first matches are built by hand.';
...
window.__dgFootVer='565';console.log('Demigod v565');
